...
const CutVideo = memo(() => {
  ...
  }, [togglePlayPause, seekTo, videoState, setVolume, toggleMute, handleCutVideo, handleFullscreen, setVideoInfo]);
  ...
  return (
    <div className={`cut-video-wrapper min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
      {/* Header với toolbar */}
      <div className={`sticky top-0 z-40 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-b px-6 py-4`}>
          ...
          <div className="flex flex-1">
            ...
            <div className="flex-1 p-6">
              ...
              <Card className={`mb-4 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
                <Title level={5} className={`mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                  Chế độ cắt video
                </Title>
                <Radio.Group
                  value={videoInfo.mode}
                  onChange={e => setVideoInfo(prev => ({ ...prev, mode: e.target.value }))}
                  className="w-full"
                >
                  <Row gutter={[16, 16]}>
                    <Col xs={24} sm={12} lg={6}>
                      <Radio.Button value="manual" className="w-full text-center">
                        <div className="p-2">
                    ...
                    <Col xs={24} sm={12} lg={6}>
                      <Radio.Button value="segments" className="w-full text-center">
                        <div className="p-2">
                    ...
                    <Col xs={24} sm={12} lg={6}>
                      <Radio.Button value="smart" className="w-full text-center">
                        <div className="p-2">
                    ...
                    <Col xs={24} sm={12} lg={6}>
                      <Radio.Button value="batch" className="w-full text-center">
                        <div className="p-2">
                    ...
                    <Row gutter={16}>
                      <Col span={12}>
                        ...
                        <Select
                          ...
                          onChange={val => setVideoInfo(prev => ({ ...prev, multiType: val }))}
                  ...
                  <Col xs={24} sm={8}>
                    <div className="text-center">
                      <Switch
                        ...
                        onChange={checked => setVideoInfo(prev => ({ ...prev, lossless: checked }))}
                        className="mb-2"
                      />
                  ...
                  <Col xs={24} sm={8}>
                    <div className="text-center">
                      <Switch
                        ...
                        onChange={checked => setVideoInfo(prev => ({ ...prev, snapKeyframe: checked }))}
                        className="mb-2"
                      />
                  ...
                  <Col xs={24} sm={8}>
                    <div className="text-center">
                      <Switch
                        ...
                        onChange={checked => handleAdvancedOptionChange('preserveAudio', checked)}
                        className="mb-2"
                      />
                ...
                <Row gutter={16}>
                  ...
                  <Col xs={24} sm={8}>
                    <Button
                      ...
                      icon={<ReloadOutlined />}
                      onClick={() => {
                        setVideoInfo(prev => ({ ...prev, cutStart: 0, cutEnd: videoState.duration || 10 }));
                        seekTo(0);
                      }}
                      disabled={!videoInfo.selectedFile}
                      className="w-full"
                ...
                <Card className="mt-4">
                  <div className="text-center py-12">
                    ...
                    <Text className="text-gray-400 mb-6 block">
                      Vui lòng chọn một file video để bắt đầu chỉnh sửa hoặc kéo thả file vào đây
                    </Text>
                    <Button
                      type="primary"
                      size="large"
            ...
            <div className={`w-80 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-l overflow-y-auto`}>
              <div className="p-4">
                ...
                {videoInfo.selectedFile && (
                  <Card className={`mt-4 ${theme === 'dark' ? 'bg-gray-700 border-gray-600' : 'bg-gray-50'}`} size="small">
                    <Title level={5} className={`mb-3 ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                      Thông tin video
                    </Title>
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>
                          {formatTime(Math.abs(videoInfo.cutEnd - videoInfo.cutStart))}
                        </span>
                      </div>
                    </div>
                  </Card>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
          <Card className="w-[600px] max-h-[80vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <Title level={4} className="mb-0">Cài đặt nâng cao</Title>
              <Button icon={<CloseOutlined />} onClick={() => setShowSettings(false)} />
            </div>
            ...
            <div className="flex justify-end space-x-2 mt-6 pt-4 border-t">
              ...
              <Button type="primary" onClick={saveSettings}>Lưu cài đặt</Button>
            </div>
          </Card>
        </div>
      )}
      ...
      {showShortcuts && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
          <Card className="w-[500px]">
            <div className="flex items-center justify-between mb-4">
              <Title level={4} className="mb-0">Phím tắt</Title>
              <Button icon={<CloseOutlined />} onClick={() => setShowShortcuts(false)} />
            </div>
            <div className="space-y-3">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <span>Cắt video</span>
                <kbd className="px-2 py-1 bg-gray-100 rounded text-sm">Ctrl + X</kbd>
              </div>
            </div>
          </Card>
        </div>
