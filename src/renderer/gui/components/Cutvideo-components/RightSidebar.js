...
import { Card, Typography, Radio, Switch, Select, InputNumber, Tooltip, Tabs, Button } from 'antd';
import { ScissorOutlined, SplitCellsOutlined, ThunderboltOutlined, AppstoreOutlined, EyeOutlined } from '@ant-design/icons';
