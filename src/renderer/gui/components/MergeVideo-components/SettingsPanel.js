...
const SettingsPanel = memo(
  ({
    ...
    const videoCodecs = [
      {
        value: "h264",
        label: "H.264 (Khuyến nghị)",
        description: "Tương thích tốt, kích thước vừa phải",
      },
      {
        value: "h265",
        label: "H.265/HEVC",
        description: "Chất lượng cao, kích thước nhỏ",
      },
      { value: "vp9", label: "VP9", description: "Mã nguồn mở, tối ưu web" },
      {
        value: "av1",
        label: "AV1",
        description: "Công nghệ mới nhất, hiệu quả cao",
      },
    ];
    ...
    const qualityPresets = [
      ...
      },
      {
        ...
        bitrate: 4000,
        description: "Cân bằng chất lượng/dung lượng",
      },
      {
        value: "low",
        label: "💾 Thấp (480p)",
    ...
    return (
      ...
      >
        <Card
          ...
          size="small"
          styles={{
            body: { padding: 0 } // Replaced deprecated bodyStyle
          }}
          extra={
            <Space>
        ...
        >
                  ...
                  children: (
                    <>
                      <Form.Item
                        ...
                        name="outputFormat"
                        tooltip={
                          showTooltips ? "Chọn định dạng file video" : ""
                        }
                      >
                        <Select>
                      ...
                      {currentMode !== "beginner" && (
                        <>
                          <Form.Item
                            ...
                            name="resolution"
                            tooltip={
                              showTooltips ? "Độ phân giải video xuất" : ""
                            }
                          >
                            <Select>
                          ...
                          <Form.Item
                            ...
                            name="aspectRatio"
                            tooltip={
                              showTooltips ? "Tỷ lệ khung hình video" : ""
                            }
                          >
                            <Select>
                      ...
                      {currentMode !== "beginner" && (
                        <>
                          ...
                          <Form.Item
                            ...
                            tooltip={
                              showTooltips
                                ? "Chất lượng video, càng cao càng rõ nét"
                                : ""
                            }
                          >
                            <InputNumber
                          ...
                          <Form.Item
                            ...
                            name="fps"
                            tooltip={
                              showTooltips ? "Số khung hình trên giây" : ""
                            }
                          >
                            <Select>
                      ...
                      {currentMode === "expert" && (
                        <>
                          <Form.Item
                            ...
                            tooltip={
                              showTooltips
                                ? "Cách kiểm soát chất lượng video"
                                : ""
                            }
                          >
                            <Select>
                          ...
                          <Form.Item
                            ...
                            tooltip={
                              showTooltips
                                ? "Giá trị CRF (0-51, thấp hơn = chất lượng cao hơn)"
                                : ""
                            }
                          >
                            <InputNumber
                    ...
                    <>
                      ...
                      {currentMode !== "beginner" && (
                        <Form.Item
                          ...
                          tooltip={
                            showTooltips
                              ? "Cân bằng âm lượng giữa các clip"
                              : ""
                          }
                        >
                          <Switch
                            checkedChildren="Cân bằng âm lượng"
                  ...
                  children: (
                    <>
                      ...
                      <Form.Item
                        ...
                        tooltip={
                          showTooltips
                            ? "Mã hóa 2 lần để chất lượng tốt hơn"
                            : ""
                        }
                      >
                        <Switch
                          checkedChildren="Two-pass encoding"
                          unCheckedChildren="Single-pass"
                        />
                      </Form.Item>
          ...
          <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded">
            ...
            <div className="text-xs space-y-1">
              <div>
                Dung lượng ước tính: <strong>{getEstimatedFileSize()}</strong>
              </div>
              <div>
                Thời gian ước tính:{" "}
                <strong>
