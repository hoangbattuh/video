                ...
                <List.Item.Meta
                  ...
                  description={
                    <div className="text-xs text-gray-500">
                      ...
                      {currentMode !== "beginner" && (
                        <div>
                          {formatDuration(file.duration)} • {file.width}x
                          {file.height}
                        </div>
                      )}
                    </div>
        ...
        {currentMode !== "beginner" && safeVideoFiles.length > 0 && (
          ...
          >
            <div className="text-sm space-y-1">
              <div>
                Tổng video: <strong>{safeVideoFiles.length}</strong>
              </div>
              <div>
                Tổng dung lượng:{" "}
                <strong>
                  {formatFileSize(
                    safeVideoFiles.reduce((sum, file) => sum + file.size, 0)
                  )}
                </strong>
              </div>
              <div>
